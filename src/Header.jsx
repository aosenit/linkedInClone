import "./Header.css"
import {Search, SupervisorAccount, BusinessCenter, Chat, Notifications, Home} from '@material-ui/icons';
    ...
    return (
      <div className="header">
        ...
        <div className="header-right">
          ...
          <HeaderOption avatar title={user?.displayName} onClick={logoutOfApp}/>
        </div>
      </div>
    );
}
